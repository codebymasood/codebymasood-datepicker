...
(() => {
  ...
  const dp1 = new CbmDatepicker('#input1', {
    outputFormat: 'both',
  ...
  const dp2 = new CbmDatepicker('#input2', {
    outputFormat: 'both',
  ...
  const dp3 = new CbmDatepicker('#input3', {
    rangeMode: true,
    outputFormat: 'both',
    onRangeSelect: (p) => {
      showOutput('out3', p);
  ...
  // ── Inline Instances ──
  const dpInline1 = new CbmDatepicker('#inlineHost1', {
    inline: true,
    outputFormat: 'both',
  ...
  const dpInline2 = new CbmDatepicker('#inlineHost2', {
    inline: true,
    rangeMode: true,
    outputFormat: 'both',
    onRangeSelect: (p) => {
  ...
  themeSwitcher.querySelectorAll('.theme-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (config.attr) {
        document.documentElement.setAttribute('data-cbm-theme', config.attr);
      } else {
